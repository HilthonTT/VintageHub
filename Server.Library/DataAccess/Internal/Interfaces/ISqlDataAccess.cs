...
public interface ISqlDataAccess
{
    ...
    Task<List<T>> LoadDetailedDataAsync<T>(string splitOnColumn, string storedProcedure, DynamicParameters paramaters, params object[] secondaryObjects);
    Task<T> LoadFirstOrDefaultAsync<T>(string storedProcedure, DynamicParameters parameters);
    Task<T> LoadFirstOrDefaultDetailedDataAsync<T>(string splitOnColumn, string storedProcedure, DynamicParameters paramaters, params object[] secondaryObjects);
